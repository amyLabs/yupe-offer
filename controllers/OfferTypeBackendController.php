<?php
/**
 * OfferTypeBackendController контроллер панели управления для управления предложениями
 *
...
class OfferTypeBackendController extends yupe\components\controllers\BackController
{
    ...
    public function actionCreate()
    {
        ...
        if (($data = Yii::app()->getRequest()->getPost('OfferType')) !== null) {
    ...
    public function loadModel($id)
    {
        if ($this->_model === null || $this->_model->id !== $id) {
            ...
            if (($this->_model = OfferType::model()->findByPk($id)) === null) {
                throw new CHttpException(
                    404,
